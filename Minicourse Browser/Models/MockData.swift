...
extension Course {
    static let minicourses: [Course] = [
        ...
        .init(
            code: "CIS 1953",
            name: "3D Game Development in Unreal Engine",
            description: "The Unreal Engine is a state of the art tool for computer graphics creation. It provides an unparalleled number of rendering, physics, and design tools for developers. The Unreal Engine has become a staple in numerous fields from video games to films to health care to physical simulation to geospatial processing. This course will explore the application of Unreal Engine specifically in the development of 3D video games. Taking this class will foster proficiency in use of the engine, understanding of common practices and techniques in video game creation, and linear algebra and C++ in a game context. The course is recommended for computer science students interested in video game development, or prospective students to the Computer Graphics and Game Technology program.",
            icon: "move.3d"
        ),
        .init(
            code: "CIS 1962",
